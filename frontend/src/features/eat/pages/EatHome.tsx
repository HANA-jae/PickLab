            ...
            {selectedCategory5 && (
              <div className="flex justify-center mt-10">
                <button
                  ...
                  className="group relative px-14 py-6 bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 text-white font-bold text-xl rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-purple-500/50 border border-purple-500/30 animate-bounce"
                >
                  {/* 배경 그라데이션 애니메이션 */}
                  ...
                  <span className="relative z-10 flex items-center gap-3">
                    <svg className="w-7 h-7 group-hover:rotate-180 transition-transform duration-500" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M11 3a1 1 0 10-2 0v1a1 1 0 102 0V3zM15.657 5.757a1 1 0 00-1.414-1.414l-.707.707a1 1 0 001.414 1.414l.707-.707zM18 10a1 1 0 01-1 1h-1a1 1 0 110-2h1a1 1 0 011 1zM5.05 6.464A1 1 0 106.464 5.05l-.707-.707a1 1 0 00-1.414 1.414l.707.707zM5 10a1 1 0 01-1 1H3a1 1 0 110-2h1a1 1 0 011 1zM8 16v-1h4v1a2 2 0 11-4 0zM12 14c.015-.34.208-.646.477-.859a4 4 0 10-4.954 0c.27.213.462.519.476.859h4.002z" />
                    </svg>
                    <span className="tracking-wide"> 음식 추천받기</span>
                  </span>
                  
                  {/* 테두리 발광 효과 */}
                  <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ boxShadow: '0 0 20px 2px rgba(168, 85, 247, 0.4)' }}></div>
                </button>
              </div>
            )}
